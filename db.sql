...
VALUES
-- 管理员用户
('superadmin', '123456', 'superadmin@moviebooking.com', '13800000000', '/avatars/admin.jpg', 1, 'ACTIVE', NOW(), 10, NOW()),
...
-- VIP用户
('vipuser1', '123456', 'vip1@example.com', '13900000001', '/avatars/vip1.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 2 DAY), 15, DATE_SUB(NOW(), INTERVAL 120 DAY)),
('vipuser2', '123456', 'vip2@example.com', '13900000002', '/avatars/vip2.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 1 DAY), 12, DATE_SUB(NOW(), INTERVAL 90 DAY)),
-- 普通用户
('user1', '123456', 'user1@example.com', '13700000001', '/avatars/user1.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 5 DAY), 8, DATE_SUB(NOW(), INTERVAL 60 DAY)),
('user2', '123456', 'user2@example.com', '13700000002', '/avatars/user2.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 3 DAY), 6, DATE_SUB(NOW(), INTERVAL 45 DAY)),
('user3', '123456', 'user3@example.com', '13700000003', '/avatars/user3.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 1 DAY), 10, DATE_SUB(NOW(), INTERVAL 30 DAY)),
('user4', '123456', 'user4@example.com', '13700000004', '/avatars/user4.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 2 DAY), 5, DATE_SUB(NOW(), INTERVAL 20 DAY)),
('user5', '123456', 'user5@example.com', '13700000005', '/avatars/user5.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 1 DAY), 7, DATE_SUB(NOW(), INTERVAL 15 DAY)),
-- 新注册用户
('newuser1', '123456', 'new1@example.com', '13600000001', '/avatars/new1.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 1 DAY), 2, DATE_SUB(NOW(), INTERVAL 5 DAY)),
('newuser2', '123456', 'new2@example.com', '13600000002', '/avatars/new2.jpg', 3, 'ACTIVE', DATE_SUB(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 3 DAY)),
-- 休眠用户
('inactive1', '123456', 'inactive1@example.com', '13500000001', '/avatars/inactive1.jpg', 3, 'INACTIVE', DATE_SUB(NOW(), INTERVAL 190 DAY), 3, DATE_SUB(NOW(), INTERVAL 200 DAY)),
('inactive2', '123456', 'inactive2@example.com', '13500000002', '/avatars/inactive2.jpg', 3, 'INACTIVE', DATE_SUB(NOW(), INTERVAL 200 DAY), 2, DATE_SUB(NOW(), INTERVAL 220 DAY));
...
WHERE
    (u.username LIKE 'new%' AND g.name = '新注册用户') OR
    (u.username LIKE 'vip%' AND g.name = 'VIP用户组') OR
    (u.username LIKE 'inactive%' AND g.name = '休眠用户') OR
    (u.role_id = 3 AND g.name = '活跃用户' AND u.last_login > DATE_SUB(NOW(), INTERVAL 30 DAY) AND u.login_count >= 5) OR
    (u.id % 3 = 0 AND g.name = '营销活动组') OR
    (u.id % 5 = 0 AND g.name = '测试用户组') OR
    (u.id % 4 = 0 AND g.name = '学生用户组');
...
BEGIN
    ...
    hall_loop: LOOP
        ...
        WHILE row_counter <= total_rows_var DO
                SET col_counter = 1;

                WHILE col_counter <= total_columns_var DO
                    -- 确定座位类型和价格乘数
...
INSERT INTO movies (title, description, director, actors, genre, duration_minutes, release_date, end_date, poster_url, trailer_url, base_price, status, rating, rating_count, view_count, language, country)
VALUES
-- 动作/科幻类
('复仇者联盟4：终局之战', '漫威电影宇宙的史诗级终章，讲述了复仇者联盟为了挽回灭霸消灭宇宙一半生命的惨剧，重新集结并踏上了一场穿越时空的冒险。英雄们将面临前所未有的挑战，为了拯救宇宙，他们必须付出一切。这部电影不仅有震撼的视觉效果和激动人心的战斗场面，还有感人至深的情感故事，完美诠释了英雄主义和自我牺牲的精神。', '安东尼·罗素,乔·罗素', '小罗伯特·唐尼,克里斯·埃文斯,克里斯·海姆斯沃斯,马克·鲁法洛,斯嘉丽·约翰逊,杰瑞米·雷纳,保罗·路德,布丽·拉尔森,唐·钱德尔,凯伦·吉兰,乔什·布洛林', '动作,科幻,冒险', 181, '2019-04-26', '2023-12-31', '/posters/avengers4.jpg', '/trailers/avengers4.mp4', 45.00, 'NOW_SHOWING', 9.2, 125000, 5000000, '英语', '美国'),

('阿凡达：水之道', '《阿凡达：水之道》是詹姆斯·卡梅隆导演的科幻史诗续集，故事发生在潘多拉星球上，讲述了杰克·萨利和奈蒂莉组建家庭后的生活。当一个熟悉的威胁重返潘多拉，萨利一家被迫离开家园，前往潘多拉海洋中的珊瑚礁地区寻求庇护。在这里，他们必须适应水中生活，并与当地的海洋部落建立联系。影片以令人惊叹的视觉效果展现了潘多拉海底世界的壮丽景色，同时探讨了家庭、归属和环境保护等主题。', '詹姆斯·卡梅隆', '萨姆·沃辛顿,佐伊·索尔达娜,西格妮·韦弗,凯特·温斯莱特,杰梅奈·克莱门特,史蒂芬·朗', '科幻,冒险,动作', 192, '2022-12-16', '2023-12-31', '/posters/avatar2.jpg', '/trailers/avatar2.mp4', 55.00, 'NOW_SHOWING', 8.7, 95000, 3200000, '英语', '美国'),

('星际穿越', '《星际穿越》是克里斯托弗·诺兰导演的科幻杰作，讲述了在地球面临生存危机的未来，一组宇航员通过一个神秘的虫洞开始星际旅行，寻找人类新家园的故事。影片深入探讨了时间相对论、黑洞物理学和五维空间等科学概念，同时也是一个关于爱、牺牲和人类求生本能的感人故事。库珀（马修·麦康纳饰）作为宇航员必须在拯救人类和回到自己孩子身边之间做出艰难的选择，而爱可能是跨越时空的唯一力量。诺兰通过壮观的视觉效果和精心设计的情节，创造了一部既有科学深度又充满情感力量的电影杰作。', '克里斯托弗·诺兰', '马修·麦康纳,安妮·海瑟薇,杰西卡·查斯坦,比尔·欧文,迈克尔·凯恩,麦肯吉·弗依', '科幻,冒险,剧情', 169, '2014-11-07', '2023-12-31', '/posters/interstellar.jpg', '/trailers/interstellar.mp4', 40.00, 'NOW_SHOWING', 9.1, 76000, 2100000, '英语', '美国'),

('沙丘', '《沙丘》改编自弗兰克·赫伯特的同名科幻小说，讲述了在遥远的未来，贵族保罗·厄崔迪家族接受了管理沙漠行星厄拉科斯（又称"沙丘"）的任务。这个星球是珍贵资源香料的唯一来源，能够延长生命并提供超人的思维能力。然而，这是一个充满危险的任务，因为行星上充满了巨大的沙虫、恶劣的环境和当地的弗雷曼人。当一场可怕的阴谋导致保罗的家族遭到背叛，他必须在这个敌对的世界中生存下来，并实现自己作为救世主的命运。导演丹尼斯·维伦纽瓦以壮观的视觉效果和深刻的主题探索，创造了一部宏大的科幻史诗。', '丹尼斯·维伦纽瓦', '提莫西·查拉梅,丽贝卡·弗格森,奥斯卡·伊萨克,赞达亚,杰森·莫玛,哈维尔·巴登', '科幻,冒险,剧情', 155, '2021-10-22', '2023-12-31', '/posters/dune.jpg', '/trailers/dune.mp4', 48.00, 'NOW_SHOWING', 8.9, 68000, 1900000, '英语', '美国'),

-- 动画/家庭类
('疯狂动物城', '《疯狂动物城》是一部充满智慧与温情的动画电影，讲述了兔子朱迪·霍普斯从小就梦想成为动物城的一名警察。尽管没有人相信一只兔子能胜任这个工作，但她凭借自己的努力和决心，成功地实现了梦想。然而，初到动物城的朱迪很快发现这个表面和谐的城市暗藏危机——多位食草动物神秘失踪。为了解开这个谜团，朱迪不得不与狡猾的狐狸尼克·王德联手。在调查过程中，他们揭露了一个足以摧毁动物城和平的惊天阴谋。这部电影不仅有精彩的冒险故事和幽默的对白，还通过动物世界的比喻，深刻探讨了偏见、包容和自我实现等社会主题。', '拜伦·霍华德,瑞奇·摩尔', '金妮弗·古德温,杰森·贝特曼,伊德里斯·艾尔巴,珍妮·斯蕾特,内特·托伦斯,邦尼·亨特', '动画,喜剧,冒险', 108, '2016-03-04', '2023-12-31', '/posters/zootopia.jpg', '/trailers/zootopia.mp4', 28.00, 'NOW_SHOWING', 8.9, 67000, 2200000, '英语', '美国'),

('玩具总动员4', '《玩具总动员4》是皮克斯经典系列的最新续集，讲述了胡迪和他的玩具伙伴们跟随新主人邦妮开始新生活的故事。当邦妮在幼儿园手工课上创造了一个叫"叉叉"的新玩具，并视它为心爱之物时，胡迪主动承担起保护这个不安的新成员的责任。在一次公路旅行中，胡迪与多年前失散的老朋友牧羊女重逢，并发现她已经适应了没有主人的自由生活。面对牧羊女提出的加入她的选择，以及保护叉叉和回到邦妮身边的责任，胡迪必须做出艰难的决定。这部电影不仅延续了系列一贯的冒险和幽默，还深入探讨了目标、责任和人生意义等主题，为这个备受喜爱的系列带来了感人的告别。', '乔什·库雷', '汤姆·汉克斯,蒂姆·艾伦,安妮·波茨,托尼·海尔,基努·里维斯,克里斯蒂娜·亨德里克斯', '动画,冒险,喜剧', 100, '2019-06-21', '2023-12-31', '/posters/toystory4.jpg', '/trailers/toystory4.mp4', 30.00, 'NOW_SHOWING', 8.5, 58000, 1800000, '英语', '美国'),

('寻梦环游记', '《寻梦环游记》是一部充满墨西哥文化色彩的动画电影，讲述了热爱音乐的小男孩米格尔的奇幻冒险。在一个禁止音乐的家庭中长大的米格尔，梦想成为像偶像德拉库斯一样的音乐家。在亡灵节这天，一连串的意外事件使米格尔穿越到了亡灵世界。在那里，他必须寻找已故的音乐家祖先的祝福才能返回人间，同时也揭开了家族历史中被隐藏的秘密。这部电影以绚丽的色彩和动人的音乐，探索了家庭、记忆和追求梦想的重要性，同时也向墨西哥的亡灵节传统致敬。', '李·昂克里奇,阿德里安·莫利纳', '安东尼·冈萨雷斯,盖尔·加西亚·贝纳尔,本杰明·布拉特,阿兰娜·乌巴赫,芮妮·维克托,杰米·卡米尔', '动画,冒险,喜剧', 105, '2017-11-22', '2023-12-31', '/posters/coco.jpg', '/trailers/coco.mp4', 32.00, 'NOW_SHOWING', 9.0, 72000, 2000000, '英语,西班牙语', '美国'),

-- 剧情类
('肖申克的救赎', '《肖申克的救赎》是一部经典的剧情片，讲述了银行家安迪·杜弗雷因被错误地指控谋杀妻子及其情人而被判终身监禁的故事。在肖申克监狱的残酷环境中，安迪凭借自己的智慧和坚韧不拔的精神，不仅赢得了狱友的尊重，还成为了监狱长和狱警的财务顾问。他与狱友"红"建立了深厚的友谊，同时秘密策划着自己的越狱计划。经过近二十年的耐心等待和精心准备，安迪最终成功越狱，实现了自由和正义。这部电影通过安迪的故事，深刻探讨了希望、友谊、自由和救赎等永恒主题，被誉为电影史上的经典之作。', '弗兰克·德拉邦特', '蒂姆·罗宾斯,摩根·弗里曼,鲍勃·冈顿,威廉姆·赛德勒,克兰西·布朗,吉尔·贝罗斯', '剧情,犯罪', 142, '1994-09-23', '2023-12-31', '/posters/shawshank.jpg', '/trailers/shawshank.mp4', 30.00, 'NOW_SHOWING', 9.7, 156000, 4200000, '英语', '美国'),

('绿皮书', '《绿皮书》是一部感人至深的公路电影，基于真实故事改编。故事发生在1962年，意大利裔美国人托尼·利普（维果·莫腾森饰）受雇于非裔古典钢琴家唐·雪莉（马赫沙拉·阿里饰），担任其南方巡演的司机兼保镖。在种族隔离严重的美国南方，这对性格迥异的组合——粗犷直率的托尼和优雅知性的唐博士——必须依靠"绿皮书"（一本为有色人种旅行者提供安全住宿信息的指南）来完成他们的旅程。在旅途中，两人逐渐超越了最初的雇佣关系，建立了真挚的友谊，同时也面对并克服了种族偏见和社会歧视。这部电影以幽默温暖的方式，探讨了种族、阶级和友谊的复杂主题，展现了人性的光辉和社会的进步。', '彼得·法雷里', '维果·莫腾森,马赫沙拉·阿里,琳达·卡德里尼,塞巴斯蒂安·马尼斯科,迪米特·D·马里诺夫,迈克·哈顿', '剧情,喜剧,传记', 130, '2018-11-16', '2023-12-31', '/posters/greenbook.jpg', '/trailers/greenbook.mp4', 35.00, 'NOW_SHOWING', 8.9, 65000, 1800000, '英语', '美国'),

('当幸福来敲门', '《当幸福来敲门》是一部基于克里斯·加德纳真实经历的励志电影。故事讲述了单身父亲克里斯·加德纳（威尔·史密斯饰）在经历事业失败、妻子离开和经济困境后，仍然坚持抚养年幼的儿子。为了改变命运，他争取到了一家证券公司的无薪实习机会，希望通过自己的努力获得正式职位。在实习期间，克里斯必须面对无家可归、经济拮据等种种困难，但他从未放弃对美好生活的追求和对儿子的责任。这部电影真实展现了一个人在逆境中的坚韧和勇气，以及父爱的伟大，传递了即使在最黑暗的时刻也不应放弃希望的积极信息。', '加布里埃莱·穆奇诺', '威尔·史密斯,贾登·史密斯,坦迪·牛顿,布莱恩·豪威,詹姆斯·凯伦,丹·卡斯泰兰尼塔', '剧情,传记', 117, '2006-12-15', '2023-12-31', '/posters/pursuit_of_happyness.jpg', '/trailers/pursuit_of_happyness.mp4', 32.00, 'NOW_SHOWING', 8.8, 70000, 1900000, '英语', '美国'),

-- 爱情/浪漫类
('泰坦尼克号', '《泰坦尼克号》是詹姆斯·卡梅隆导演的史诗级爱情灾难片，讲述了发生在1912年的一个跨越阶级的爱情故事。贫穷但自由的艺术家杰克·道森（莱昂纳多·迪卡普里奥饰）在赌博中赢得了泰坦尼克号的船票，在船上他邂逅了上流社会的少女露丝·德威特·布克特（凯特·温斯莱特饰）。尽管露丝已经与富有的卡尔·豪利订婚，但她与杰克之间产生了真挚的爱情。当这艘被称为"永不沉没"的豪华客轮撞上冰山并开始沉没时，杰克和露丝的爱情，以及船上1500多名乘客的生命，都面临着生死考验。这部电影不仅是一个动人的爱情故事，还通过泰坦尼克号的悲剧，展现了人性在灾难面前的勇气、牺牲和尊严。', '詹姆斯·卡梅隆', '莱昂纳多·迪卡普里奥,凯特·温斯莱特,比利·赞恩,凯西·贝茨,弗兰西丝·费舍,格洛丽亚·斯图尔特', '爱情,灾难,剧情', 194, '1997-12-19', '2023-12-31', '/posters/titanic.jpg', '/trailers/titanic.mp4', 35.00, 'NOW_SHOWING', 9.4, 98000, 3500000, '英语', '美国'),

('爱乐之城', '《爱乐之城》是一部充满音乐与舞蹈的现代爱情故事，讲述了在洛杉矶追求梦想的两个年轻人的相遇与相爱。米娅（艾玛·斯通饰）是一位怀揣演员梦想的咖啡店女服务员，塞巴斯蒂安（瑞恩·高斯林饰）则是一位热爱传统爵士乐并梦想开设自己爵士乐俱乐部的钢琴家。两人在洛杉矶的不同场合多次偶遇，从最初的不屑到相互吸引，他们坠入爱河并互相支持对方的梦想。然而，随着各自事业的发展，他们的关系面临着选择与牺牲的考验。这部电影以华丽的歌舞场景和动人的音乐，展现了梦想、爱情和艺术的美丽与残酷，以及人生中那些必须做出的艰难选择。', '达米恩·查泽雷', '瑞恩·高斯林,艾玛·斯通,约翰·传奇,罗丝玛丽·德薇特,芬·维特洛克,J·K·西蒙斯', '爱情,音乐,剧情', 128, '2016-12-09', '2023-12-31', '/posters/lalaland.jpg', '/trailers/lalaland.mp4', 38.00, 'NOW_SHOWING', 8.6, 62000, 1700000, '英语', '美国'),

-- 恐怖/惊悚类
('寂静之地', '《寂静之地》是一部创新的恐怖惊悚片，设定在一个后启示录的世界，地球被具有超强听力的外星生物入侵，任何声音都可能导致致命的攻击。故事聚焦于艾伯特一家，他们在这个必须保持绝对安静的世界中求生存。父亲李（约翰·卡拉辛斯基饰）和母亲伊芙琳（艾米莉·布朗特饰）竭尽全力保护他们的孩子，包括聋哑的女儿里根和年幼的儿子马库斯。当伊芙琳怀孕并即将分娩时，家庭面临着前所未有的挑战——如何在不发出声音的情况下生下并抚养一个婴儿。这部电影通过极简的对白和精心设计的声音效果，创造了持续的紧张感和恐怖氛围，同时也是一个关于家庭、牺牲和生存的感人故事。', '约翰·卡拉辛斯基', '艾米莉·布朗特,约翰·卡拉辛斯基,米利森特·西蒙兹,诺亚·尤佩,凯德·伍德沃德', '恐怖,惊悚,科幻', 90, '2018-04-06', '2023-12-31', '/posters/quiet_place.jpg', '/trailers/quiet_place.mp4', 42.00, 'NOW_SHOWING', 8.5, 55000, 1600000, '英语', '美国'),

-- 喜剧类
('小丑', '《小丑》是一部黑暗而深刻的角色研究电影，讲述了DC漫画中著名反派角色小丑的起源故事。故事设定在1981年的哥谭市，亚瑟·弗莱克（华金·菲尼克斯饰）是一个生活困顿的失败喜剧演员，同时也是一个患有精神疾病的社会边缘人。他在社会的冷漠和残酷对待下，逐渐失去理智，最终转变成为了哥谭市的犯罪王子——小丑。这部电影以写实主义的手法，探讨了精神健康、社会不平等和身份认同等严肃主题，展现了一个普通人如何在极端环境下转变为反社会的罪犯。华金·菲尼克斯凭借对亚瑟复杂心理和身体变化的精湛演绎，获得了奥斯卡最佳男主角奖。', '托德·菲利普斯', '华金·菲尼克斯,罗伯特·德尼罗,扎齐·比兹,弗兰西丝·康罗伊,布莱特·卡伦,肖恩·古恩', '剧情,犯罪,惊悚', 122, '2019-10-04', '2023-12-31', '/posters/joker.jpg', '/trailers/joker.mp4', 45.00, 'NOW_SHOWING', 8.7, 80000, 2500000, '英语', '美国');
...
-- 创建存储过程为每个影厅安排场次
DELIMITER //
CREATE PROCEDURE schedule_hall_sessions(IN hall_id_var INT, IN session_date DATE, IN start_time_str VARCHAR(5), IN end_time_str VARCHAR(5))
BEGIN
    ...
    time_loop: WHILE cur_time < end_datetime DO
        -- 获取下一部电影
        SELECT movie_id, duration INTO movie_id_var, movie_duration
        FROM temp_movies
        ...
        -- 计算电影结束时间
        SET movie_end_time = DATE_ADD(cur_time, INTERVAL movie_duration + 20 MINUTE); -- 加20分钟清场时间
...
WHERE s.is_deleted = 0 AND ms.is_deleted = 0;
