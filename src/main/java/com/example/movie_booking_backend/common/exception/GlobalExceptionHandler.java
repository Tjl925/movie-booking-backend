...
public class GlobalExceptionHandler {
    ...
    public JsonResponse<String> handleValidationException(MethodArgumentNotValidException e) {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public JsonResponse<String> handleBindException(BindException e) {
    ...
    public JsonResponse<String> handleBadCredentialsException(BadCredentialsException e) {
    ...
    public JsonResponse<String> handleAccessDeniedException(AccessDeniedException e) {
        log.warn("权限不足: {}", e.getMessage());
        return JsonResponse.failure("权限不足，无法访问该资源");
    }
